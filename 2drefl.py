...
def reflect(line):
    ...
    for i in range(len(line)):
        x, y, w = line[i]
        new_coords = [
            reflection_matrix[0][0] * x + reflection_matrix[0][1] * y + reflection_matrix[0][2] * w,
            reflection_matrix[1][0] * x + reflection_matrix[1][1] * y + reflection_matrix[1][2] * w,
            reflection_matrix[2][0] * x + reflection_matrix[2][1] * y + reflection_matrix[2][2] * w
        ]
