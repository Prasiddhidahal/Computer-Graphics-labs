...
def scale(line, scaling_factor):
    ...
    for i in range(len(line)):
        x, y, w = line[i]
        new_coords = [
            scaling_matrix[0][0] * x + scaling_matrix[0][1] * y + scaling_matrix[0][2] * w,
            scaling_matrix[1][0] * x + scaling_matrix[1][1] * y + scaling_matrix[1][2] * w,
            scaling_matrix[2][0] * x + scaling_matrix[2][1] * y + scaling_matrix[2][2] * w
        ]
...
def main():
    ...
    while True:
        ...
        line1 = scale(line, scaling_factor)
        draw_line(line1, [1.0, 0.0, 0.0])  # Scaled line in red
